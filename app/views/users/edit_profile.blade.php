...
<div class="row">
    <div class="col-md-12">
		...
		<hr/>
			<form class="form-horizontal" action="{{ URL::to('/portal/profile/edit') }}/{{ $myUser->id }}" method="post" role="form">
				{{ Form::token() }}
...
<div class="row">
    <div class="col-md-12">
			...
			<form class="form-horizontal" action="{{ URL::to('/portal/change-password') }}/{{ $myUser->id }}" method="post" role="form">
				{{ Form::token() }}
